...
@llvm.used = appending global [5 x i8*] [i8* bitcast ([7 x i8]* @"\01L_OBJC_CLASS_NAME_" to i8*), i8* bitcast ([32 x i8]* @"\01L_OBJC_METH_VAR_NAME_" to i8*), i8* bitcast ([23 x i8]* @"\01L_OBJC_METH_VAR_TYPE_" to i8*), i8* bitcast ({ i32, i32, [1 x %struct._objc_method] }* @"\01l_OBJC_$_INSTANCE_METHODS_Bitmap" to i8*), i8* bitcast ([1 x i8*]* @"\01L_OBJC_LABEL_CLASS_$" to i8*)], section "llvm.metadata"
