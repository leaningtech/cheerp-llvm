...
define void @lifetime() sanitize_address {
  ...
  ; Memory is unpoisoned at llvm.lifetime.start.p0i8
  ...
  ; Memory is poisoned at every call to llvm.lifetime.end.p0i8
  ...
  ; One more lifetime.start.p0i8/end for the same variable %i.
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %i.ptr)
