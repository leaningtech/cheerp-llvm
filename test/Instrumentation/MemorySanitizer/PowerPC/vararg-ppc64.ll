...
; CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[SHADOW]], i8* align 8 {{.*}}, i32 16, i1 false)
; CHECK: store {{.*}} 16, {{.*}} @__msan_va_arg_overflow_size_tls
...
; CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[SHADOW]], i8* align 8 {{.*}}, i32 32, i1 false)
; CHECK: store {{.*}} 40, {{.*}} @__msan_va_arg_overflow_size_tls
