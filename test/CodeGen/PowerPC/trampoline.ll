...
@llvm.used = appending global [14 x i8*] [ i8* bitcast (%struct.objc_selector** @"\01L_OBJC_SELECTOR_REFERENCES_1" to i8*), i8* bitcast (%struct._objc_class* @"\01L_OBJC_CLASS_NSBitmapImageRep" to i8*), i8* bitcast (%struct.objc_selector** @"\01L_OBJC_SELECTOR_REFERENCES_0" to i8*), i8* bitcast ({ i32, %struct.objc_selector**, i16, i16, [1 x %struct._objc_class*] }* @"\01L_OBJC_SYMBOLS" to i8*), i8* bitcast ([14 x i8]* @"\01L_OBJC_METH_VAR_NAME_0" to i8*), i8* bitcast ([20 x i8]* @"\01L_OBJC_METH_VAR_TYPE_0" to i8*), i8* bitcast ({ i8*, i32, [1 x %struct._objc_method] }* @"\01L_OBJC_INSTANCE_METHODS_NSBitmapImageRep" to i8*), i8* bitcast ([17 x i8]* @"\01L_OBJC_CLASS_NAME_0" to i8*), i8* bitcast ([11 x i8]* @"\01L_OBJC_CLASS_NAME_1" to i8*), i8* bitcast (%struct._objc_class* @"\01L_OBJC_METACLASS_NSBitmapImageRep" to i8*), i8* bitcast ([34 x i8]* @"\01L_OBJC_METH_VAR_NAME_1" to i8*), i8* bitcast ([2 x i32]* @"\01L_OBJC_IMAGE_INFO" to i8*), i8* bitcast ([1 x i8]* @"\01L_OBJC_CLASS_NAME_2" to i8*), i8* bitcast (%struct._objc_module* @"\01L_OBJC_MODULES" to i8*) ], section "llvm.metadata"		; <[14 x i8*]*> [#uses=0]
