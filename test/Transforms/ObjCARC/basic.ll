...
@llvm.used = appending global [3 x i8*] [i8* bitcast ([5 x i8]* @"\01L_OBJC_METH_VAR_NAME_" to i8*), i8* bitcast (i8** @"\01L_OBJC_SELECTOR_REFERENCES_" to i8*), i8* bitcast ([2 x i32]* @"\01L_OBJC_IMAGE_INFO" to i8*)], section "llvm.metadata"
