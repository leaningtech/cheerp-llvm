...
; CHECK:   %V1 = load <4 x float>* bitcast (float* getelementptr inbounds ([1024 x float]* @A, i64 0, i64 0) to <4 x float>*), align 16
...
; CHECK: store <4 x float> %V1, <4 x float>* bitcast (float* getelementptr inbounds ([1024 x float]* @B, i64 0, i64 0) to <4 x float>*), align 16
  ret i32 0
; CHECK: ret i32 0
}
