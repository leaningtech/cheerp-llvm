...
@llvm.compiler.used = appending global [6 x i8*] [i8* bitcast ([4 x i8]* @OBJC_CLASS_NAME_ to i8*), i8* bitcast ([12 x i8]* @OBJC_METH_VAR_NAME_ to i8*), i8* bitcast ([8 x i8]* @OBJC_METH_VAR_TYPE_ to i8*), i8* bitcast ({ i32, i32, [1 x %struct._objc_method] }* @"\01l_OBJC_$_CATEGORY_INSTANCE_METHODS_A_$_foo" to i8*), i8* bitcast (%struct._category_t* @"\01l_OBJC_$_CATEGORY_A_$_foo" to i8*), i8* bitcast ([1 x i8*]* @"OBJC_LABEL_CATEGORY_$" to i8*)], section "llvm.metadata"
