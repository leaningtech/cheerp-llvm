...
@llvm.compiler.used = appending global [9 x i8*] [i8* bitcast ([12 x i8]* @OBJC_METH_VAR_NAME_ to i8*), i8* bitcast ([7 x i8]* @OBJC_METH_VAR_TYPE_ to i8*), i8* bitcast ([4 x i8]* @OBJC_CLASS_NAME_ to i8*), i8* bitcast ([2 x i8]* @OBJC_CLASS_NAME_.1 to i8*), i8* bitcast ({ i8*, i32, [1 x %struct._objc_method] }* @OBJC_CATEGORY_INSTANCE_METHODS_A_foo to i8*), i8* bitcast (%struct._objc_category* @OBJC_CATEGORY_A_foo to i8*), i8* bitcast ([1 x i8]* @OBJC_CLASS_NAME_.2 to i8*), i8* bitcast ({ i32, i8*, i16, i16, [1 x i8*] }* @OBJC_SYMBOLS to i8*), i8* bitcast (%struct._objc_module* @OBJC_MODULES to i8*)], section "llvm.metadata"
