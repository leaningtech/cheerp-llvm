...
{
	stream << "function " << namegen.getBuiltinName(NameGenerator::Builtin::CREATE_POINTER_ARRAY) << "(ret,start,end,elem){for(var __i__=start;__i__<end;__i__++)ret[__i__]=elem;ret[end]=4;return ret;}"
		<< NewLine;
}
