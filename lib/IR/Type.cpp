...
StructType *StructType::get(LLVMContext &Context, ArrayRef<Type*> ETypes, 
  ...
  AnonStructTypeKeyInfo::KeyTy Key(ETypes, directBase, isPacked, isByteLayout, isAsmJS);
...
void StructType::setBody(ArrayRef<Type*> Elements, bool isPacked, StructType* directBase, bool isByteLayout, bool isAsmJS) {
  ...
  Type **Elts = getContext().pImpl->TypeAllocator.Allocate<Type*>(directBase?NumElements+1:NumElements);
